...
def modified_model(input_shape=(512, 512, 3), classes=2):
    ...
    h_att_1 = tf.keras.layers.Conv2D(filters=64, kernel_size=3, padding="same", use_bias=True, name="conv1")(h)
    h_att_1 = tf.keras.layers.BatchNormalization()(h_att_1)
    h_att_1 = tf.keras.layers.ReLU()(h_att_1)

    h_1 = tf.keras.layers.Conv2D(filters=64, kernel_size=3, padding="same", use_bias=True, name="conv2")(h_att_1)
    ...
    h_att_2 = tf.keras.layers.Conv2D(filters=128, kernel_size=3, padding="same", use_bias=True, name="conv3")(h)
    h_att_2 = tf.keras.layers.BatchNormalization()(h_att_2)
    h_att_2 = tf.keras.layers.ReLU()(h_att_2)

    h_2 = tf.keras.layers.Conv2D(filters=128, kernel_size=3, padding="same", use_bias=True, name="conv4")(h_att_2)
    ...
    h_att_3 = tf.keras.layers.Conv2D(filters=256, kernel_size=3, padding="same", use_bias=True, name="conv5")(h)
    h_att_3 = tf.keras.layers.BatchNormalization()(h_att_3)
    h_att_3 = tf.keras.layers.ReLU()(h_att_3)
    
    h_3 = tf.keras.layers.Conv2D(filters=256, kernel_size=3, padding="same", use_bias=True, name="conv6")(h_att_3)
    ...
    h = tf.keras.layers.Conv2D(filters=512, kernel_size=3, padding="same", use_bias=True, name="conv7")(h)
    h = tf.keras.layers.BatchNormalization()(h)
    h = tf.keras.layers.ReLU()(h)

    h = tf.keras.layers.Conv2D(filters=512, kernel_size=3, padding="same", use_bias=True, name="conv8")(h)
    h = tf.keras.layers.BatchNormalization()(h)
    h = tf.keras.layers.ReLU()(h)
    encoder_2 = h
    ...
    model.get_layer("conv7").set_weights(backbone.get_layer("block4_conv1").get_weights())
    model.get_layer("conv8").set_weights(backbone.get_layer("block4_conv2").get_weights())
